      ...
      <div className="sm:px-16 px-6 absolute inset-0 top-[150px] max-w-7xl mx-14 flex flex-row items-start gap-5 ">
        ...
        <div>
          ...
          >
            ...
            <br />
            I am obsessed with attention to detail and always learning something
            exciting on the side. <br />
          </motion.p>
        </div>

        <div className="absolute xs:bottom-10 bottom-28 left-1/2 transform -translate-x-1/2 w-full flex justify-center items-center">
